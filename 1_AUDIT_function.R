...
describe(v1$audit_total_score_use_use)
describe(v2$audit_total_score_use_use)
describe(v3$audit_total_score_use)
describe(dataudit_scored$audit_total_score_use)
...
Mode(v1$audit_total_score_use)
Mode(v2$audit_total_score_use)
Mode(v3$audit_total_score_use)
Mode(dataudit_scored$audit_total_score_use)


#histograms
par(mfrow=c(2,2))
hist(dataudit_scored$audit_total_score_use, breaks=10, xlab = "AUDIT Score", ylim=c(0,250), col = c("lightblue"), main = "AUDIT total Score (all visits)")
hist(v1$audit_total_score_use, breaks=10, xlab = "AUDIT Score", ylim=c(0,100), col = c("lightyellow"), main = "AUDIT total Score (visit 1 only)")
hist(v2$audit_total_score_use, breaks=10, xlab = "AUDIT Score", ylim=c(0,100), col = c("lightyellow"), main = "AUDIT total Score (visit 2 only)")
hist(v3$audit_total_score_use, breaks=10, xlab = "AUDIT Score", ylim=c(0,100), col = c("lightyellow"), main = "AUDIT total Score (visit 3 only)")
